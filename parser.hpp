...
#include "complete_token_stream.hpp"
...
struct parser_t {
	...
	//     bi_addition,					DONE
	//     bi_subtraction,				DONE
	//     bi_multiplication,			DONE
	//     bi_division,					DONE
	//     bi_modulo,					DONE
	//     bi_assignment,				DONE
	//     bi_logical_and,				DONE
	//     bi_logical_or,				DONE
	//     bi_relational_equal,			DONE
	//     bi_relational_non_equal,		DONE
	//     un_value_of,					DONE
	//     un_arithmetic_positive,		DONE
	//     un_arithmetic_negative,		DONE
	//     un_address_of,				DONE
	//     un_logical_not				DONE
	//   Expressions:
	//     et_integer_literal,			DONE
	//     et_string_literal,			DONE
	//     et_character_literal,		DONE
	//     et_identifier,				DONE
	//     et_indexing,					DONE
	//     et_function_call,			DONE
	//     et_binary,					DONE
	//     et_unary						DONE
	...
	//   Multiplicative operators			* / %			DONE
	//   Additive operators					+ -				DONE
